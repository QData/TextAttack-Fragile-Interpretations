...
class TextFoolerJin2019(AttackRecipe):
    ...
    @staticmethod
    def build(model,gt_div_score=0.1):
        #
        ...
        #
        goal_function = UntargetedClassification(model,target_max_score=gt_div_score)
        #
        # Greedily swap words with "Word Importance Ranking".
        #
        search_method = GreedyWordSwapWIR(wir_method="delete")
        # search_method = ManifoldSearch(wir_method="delete")
